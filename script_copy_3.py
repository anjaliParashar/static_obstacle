...
def obstacle_gen(rec1, rec2, cir1,cir2):
    ...
    obstacle [rec1[0]:rec1[0]+100, rec1[1]:rec1[1]+200] = True
...
def coordinate_gen():
    rect_10 = np.random.randint(low=200, high = 300)
    rect_11 = np.random.randint(low=100, high = 300)
    rect_20 = np.random.randint(low=100, high = 200)
    rect_21 = np.random.randint(low=300, high = 400)
    rec1 = np.array([rect_10, rect_11])
    rec2 = np.array([rect_20, rect_21])
    cir13 = np.random.randint(low=50, high = 60)
    cir23 = np.random.randint(low=60, high = 80)
    cir10 = np.random.randint(low=100, high = 300)
    cir11 = np.random.randint(low=20, high = 150)
    cir20 = np.random.randint(low=10, high = 200)
    cir21 = np.random.randint(low=10, high = 200)
